    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('customernumber', models.ForeignKey(db_column='customerNumber', on_delete=django.db.models.deletion.DO_NOTHING, to='polls.customers')),
            ],
        ),
        migrations.CreateModel(
            name='Productlines',
        ...
        migrations.CreateModel(
            name='Payments',
            fields=[
                ('customernumber', models.OneToOneField(db_column='customerNumber', on_delete=django.db.models.deletion.DO_NOTHING, primary_key=True, serialize=False, to='polls.customers')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('productline', models.ForeignKey(db_column='productLine', on_delete=django.db.models.deletion.DO_NOTHING, to='polls.productlines')),
            ],
        ),
        migrations.CreateModel(
            name='Employees',
            fields=[
                ...
                ('officecode', models.ForeignKey(db_column='officeCode', on_delete=django.db.models.deletion.DO_NOTHING, to='polls.offices')),
                ('reportsto', models.ForeignKey(blank=True, db_column='reportsTo', null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='polls.employees')),
            ],
        ),
        migrations.AddField(
            model_name='customers',
            name='salesrepemployeenumber',
            field=models.ForeignKey(blank=True, db_column='salesRepEmployeeNumber', null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='polls.employees'),
        ),
        migrations.CreateModel(
            name='Orderdetails',
            fields=[
                ('ordernumber', models.OneToOneField(db_column='orderNumber', on_delete=django.db.models.deletion.DO_NOTHING, primary_key=True, serialize=False, to='polls.orders')),
                ...
                ('productcode', models.ForeignKey(db_column='productCode', on_delete=django.db.models.deletion.DO_NOTHING, to='polls.products')),
            ],
        ),
    ]
